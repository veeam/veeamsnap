...
blk_descr_multidev_t* blk_descr_multidev_pool_at( blk_descr_pool_t* pool, size_t index )
{
    return (blk_descr_multidev_t*)blk_descr_pool_at( pool, sizeof( blk_descr_multidev_t ), index );
}
